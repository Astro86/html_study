  ...
  <body>
    <form>
      <fieldset>
        ...
        <ul>
          <li>
            <label class="reg" for="member"
              >참여인원<small>(최대10명)</small></label
            >
            <input
              type="number"
              id="member"
          ...
          <li>
            <label class="reg" for="stuffs"
              >지원물품<small>(1인당 5개)</small></label
            >
            <input
              type="number"
              id="stuffs"
          ...
          <li>
            <label class="reg" for="satis"
              >희망 단계<small>(하,중,상)</small></label
            >
  ...
  <body>
    <form>
      ...
      <fieldset>
        ...
        <label
          ><input type="checkbox" name="mailing1" value="news" />해외
          단신</label
        >
        <label
          ><input type="checkbox" name="mailing2" value="dialog" />5분
          회화</label
        >
        <label
  ...
  <body>
    <form>
      ...
      <label
        >시작 시간<input
          type="datetime-local"
          value="2016-03-02T09:00"
          id="start" /></label
      >,
      <label
        >종료 시간<input
          type="datetime-local"
          value="2016-03-02T18:00"
          id="end"
      /></label>
    </form>
  </body>
